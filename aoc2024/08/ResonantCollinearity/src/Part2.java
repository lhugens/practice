        ...
        for (Map.Entry<String, List<int[]>> entry : freqLocations.entrySet()) {
            ...
            for (int i = 0; i < locations.size(); i++) {
                for (int j = i + 1; j < locations.size(); j++) {
                    ...
                    int[] antiNode1 = new int[]{loc1[0], loc1[1]};
                    int[] antiNode2 = new int[]{loc2[0], loc2[1]};

                    while(antiNode1[0] >= 0 && antiNode1[0] < rows && antiNode1[1] >= 0 && antiNode1[1] < cols){
                    ...
                    while(antiNode2[0] >= 0 && antiNode2[0] < rows && antiNode2[1] >= 0 && antiNode2[1] < cols){
